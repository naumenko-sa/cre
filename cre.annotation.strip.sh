...
INFO/vcfanno_gnomad_af_popmax,INFO/vcfanno_gnomad_an,INFO/vcfanno_gnomad_af,INFO/gnomAD_GC,INFO/gnomAD_GC_Female,INFO/gnomAD_GC_Male -Oz -o $bname.no_anno.vcf.gz $1
